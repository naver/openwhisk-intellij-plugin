...
public class WhiskActivationWithLogs extends WhiskActivation {
    ...
    public WhiskActivationWithLogs(String subject, List<String> logs, Map<String, Object> response) {
        this.subject = subject;
        this.logs = logs;
        this.response = response;
    }

    public WhiskActivationWithLogs(String activationId, String name, String namespace, String version, long start, long end, long duration, boolean publish, List<Map<String, Object>> annotations, String subject, List<String> logs, Map<String, Object> response) {
