...
package org.apache.openwhisk.intellij.wskdeploy.navigation.ui;
...
import org.apache.openwhisk.intellij.wskdeploy.navigation.tree.WskDeployTreeCellRenderer;
import org.apache.openwhisk.intellij.wskdeploy.navigation.tree.WskDeployTreeModel;
...
public class WskDeployWindowForm {
    ...
    public WskDeployWindowForm(Project project, ToolWindow toolWindow) {
        ...
        // Toolbar
        String actionGroupName = "WskDeployWindow.Actions.Navigation.Controls";
    ...
    private Optional<WskDeployFile> loadRegisteredWskDeploy() {
        if (wskDeployService.wskdeployPath != null && wskDeployService.wskdeployName != null) {
            ...
            return validateWskDeploy(Optional.ofNullable(file))
    ...
    private WskDeployFile loadWskDeployFileFromLocal(boolean isWindow) {
        ...
        for (String dir : dirs) {
            ...
            if (files != null && files.length > 0) {
                ...
                Optional<WskDeployBinary> wskDeployBinary = validateWskDeploy(Optional.ofNullable(file))
                        .map(validWskDeploy -> new WskDeployBinary(validWskDeploy.getPath(), validWskDeploy.getName()));
