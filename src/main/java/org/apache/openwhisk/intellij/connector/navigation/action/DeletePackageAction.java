...
import org.apache.openwhisk.intellij.connector.dialog.pkg.DeletePackageDialog;
...
public class DeletePackageAction extends AnAction {
    private final static Logger LOG = Logger.getInstance(DeletePackageAction.class);
