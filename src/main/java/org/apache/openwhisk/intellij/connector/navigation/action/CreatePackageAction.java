...
import org.apache.openwhisk.intellij.connector.dialog.pkg.PackageCreationManagerDialog;
import org.jetbrains.annotations.NotNull;

import static com.intellij.icons.AllIcons.General.Add;

public class CreatePackageAction extends AnAction {
    private final static Logger LOG = Logger.getInstance(CreatePackageAction.class);
