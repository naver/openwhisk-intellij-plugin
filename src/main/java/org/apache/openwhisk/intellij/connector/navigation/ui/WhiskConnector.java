...
package org.apache.openwhisk.intellij.connector.navigation.ui;
...
import org.apache.openwhisk.intellij.connector.navigation.actiongroup.*;
...
import org.apache.openwhisk.intellij.connector.navigation.tree.WhiskTree;
import org.apache.openwhisk.intellij.connector.navigation.tree.WhiskTreeCellRenderer;
...
public class WhiskConnector {
    private final static Logger LOG = Logger.getInstance(WhiskConnector.class);
    ...
    public WhiskConnector(Project project, ToolWindow toolWindow) {
        this.project = project;
        this.fileEditorManager = FileEditorManager.getInstance(project);

        String actionGroupName = "WhiskNavigator.Actions.Navigation.Controls";
