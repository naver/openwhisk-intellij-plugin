...
import static org.apache.openwhisk.intellij.common.utils.ParameterUtils.listMapToMap;
...
public class JsonParserUtils {
    ...
    public static String writeParameterToJson(List<Map<String, Object>> params) throws JsonProcessingException {
        return mapper.writerWithDefaultPrettyPrinter().writeValueAsString(listMapToMap(params));
    }
