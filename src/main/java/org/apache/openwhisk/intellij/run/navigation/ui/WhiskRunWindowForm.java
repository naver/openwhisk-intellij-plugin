...
package org.apache.openwhisk.intellij.run.navigation.ui;
...
import static org.apache.openwhisk.intellij.common.utils.JsonParserUtils.*;
...
public class WhiskRunWindowForm {
    ...
    public WhiskRunWindowForm(Project project, ToolWindow toolWindow) {
        ...
        ActionGroup actionActionGroup = (ActionGroup) actionManager.getAction("WhiskRunWindow.Action.Actions.Controls");
        ...
        ProgressManager.getInstance().run(new Task.Backgroundable(project, "Run action") {
            ...
            public void run(@NotNull ProgressIndicator indicator) {
                try {
                    ...
                    Optional<String> params = validateParams(paramJTextArea.getText());
                    if (params.isPresent()) {
            ...
            public void run(@NotNull ProgressIndicator indicator) {
                try {
                    ...
                    if (params.isPresent()) {
                        ...
                        if (result.isPresent()) {
                            String activationId = (String) parseMap(result.get()).get("activationId");
    ...
    private Optional<String> getResponse(WhiskActivationWithLogs activation) {
        try {
            return Optional.ofNullable(beautifyJson(writeMapToJson(activation.getResponse())));
        } catch (IOException e) {
